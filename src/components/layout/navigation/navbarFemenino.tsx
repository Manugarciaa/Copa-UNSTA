...
const navLinks: NavLink[] = [
    ...
    { id: "fase-de-grupos", title: "Fase de grupos", to: "/femenino/fase-de-grupos" },
    { id: "cuadro-de-eliminatorias", title: "Cuadro de eliminatorias", to: "/femenino/cuadro-de-eliminatorias" },
    ...
    <li className={`group relative`}>
        <Link
            ...
            className={`
                ...
                ${nav.id === "masculino" ? "text-orange-400 hover:text-orange-300" : "text-gray-300 hover:text-white"}
    ...
    return (
        <nav className="w-full fixed top-0 z-50 bg-gray-900/95 backdrop-blur-sm shadow-lg">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-16 py-4 sm:py-6 flex justify-between items-center">
                <Link href="/femenino" className="flex-shrink-0 transition-transform duration-300 hover:scale-105">
                    <Image
                ...
                {/* Mobile Menu Button */}
                <button
                    className="sm:hidden p-2 rounded-lg text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-[#2196f3] transition-all duration-300"
                    onClick={toggleMenu}
